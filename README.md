...
| [@wuyaos/pi-sync](https://www.npmjs.com/package/@wuyaos/pi-sync) | `npm:@wuyaos/pi-sync` | WebDAV 归档备份/恢复：Pi 主目录、共享 Skills、项目会话分包；退出归档在 reload/切会话时后台执行不阻塞，quit 时同步保证完成 |
